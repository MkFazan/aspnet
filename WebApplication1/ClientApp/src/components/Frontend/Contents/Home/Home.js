                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="owl-carousel owl-theme home-slider">
                            <div>
                                <a href="blog-single.html" class="a-block d-flex align-items-center height-lg my-bg-1">
                        ...
                        <span class="ml-2"><span class="fa fa-comments"></span> 3</span>
                            ...
                            <div>
                                <a href="blog-single.html" class="a-block d-flex align-items-center height-lg my-bg-2">
                                    <div class="text half-to-full">
                        ...
                        <span class="ml-2"><span class="fa fa-comments"></span> 3</span>
                            ...
                            <div>
                                <a href="blog-single.html" class="a-block d-flex align-items-center height-lg my-bg-3">
                                    <div class="text half-to-full">
